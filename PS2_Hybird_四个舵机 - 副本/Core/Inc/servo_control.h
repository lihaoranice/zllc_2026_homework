...
// 舵机编号定义
typedef enum {
    SERVO_1 = 0,  // PB6 - TIM4_CH1 - UP/DOWN键控制
    SERVO_2 = 1,  // PB7 - TIM4_CH2 - LEFT/RIGHT键控制
    SERVO_3 = 2,  // PB8 - TIM4_CH3 - △/×键控制
    SERVO_4 = 3   // PB9 - TIM4_CH4 - □/○键控制
} Servo_ID_t;
...
// 舵机速度控制
#define SERVO_STEP_ANGLE  5      // 每次按键移动角度
